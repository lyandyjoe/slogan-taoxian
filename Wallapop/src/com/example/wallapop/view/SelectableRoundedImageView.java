 ...
 * xmlns:app="http://schemas.android.com/apk/res-auto" android:id="@+id/image"
 * android:src="@drawable/photo1" android:scaleType="centerCrop"
 * app:sriv_left_top_corner_radius="16dip"
 * app:sriv_right_top_corner_radius="0dip"
 * app:sriv_left_bottom_corner_radius="48dip"
 * app:sriv_right_bottom_corner_radius="16dip" app:sriv_border_width="2dip"
 * app:sriv_border_color="#008fea" app:sriv_oval="true" />
 * 
 * @author york 
 * 
...
public class SelectableRoundedImageView extends ImageView {
    ...
    public SelectableRoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mRadii = new float[] {
                mLeftTopCornerRadius, mLeftTopCornerRadius, mRightTopCornerRadius,
    ...
    static class SelectableRoundedCornerDrawable extends Drawable {
         ...
         * 
         * @param colors The desired border color. If it's null, no border will
         *            be drawn.
         */
        public void setBorderColor(ColorStateList colors) {
            if (colors == null) {
