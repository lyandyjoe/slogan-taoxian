...
public abstract class ExtendableListView extends AbsListView {
        ...
        public void run() {
            ...
            if (child != null) {
                ...
                if (sameWindow() && !mDataChanged) {
                    handled = performLongPress(child, longPressPosition + mFirstPosition,
                            longPressId);
                }
                if (handled) {
    ...
    private boolean moveTheChildren(int deltaY, int incrementalDeltaY) {
        if (DBG)
            Log.d(TAG, "moveTheChildren deltaY: " + deltaY + "incrementalDeltaY: "
                    + incrementalDeltaY);
        ...
        if (DBG) {
            Log.d(TAG, "moveTheChildren " + " firstTop " + firstTop + " maxTop " + maxTop
     ...
     */
    private void setupChild(View child, int position, int y, boolean flowDown, boolean selected,
            boolean recycled) {
        ...
        if (needToMeasure) {
            ...
            onLayoutChild(child, position, flowDown, childrenLeft, childTop, childRight,
                    childBottom);
        } else {
    ...
    public static class ListSavedState extends ClassLoaderSavedState {
        ...
        public String toString() {
            return "ExtendableListView.ListSavedState{"
                    + Integer.toHexString(System.identityHashCode(this)) + " selectedId="
                    + selectedId + " firstId=" + firstId + " viewTop=" + viewTop + " position="
