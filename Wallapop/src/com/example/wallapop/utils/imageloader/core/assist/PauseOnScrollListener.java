 ...
 *******************************************************************************/
package com.example.wallapop.utils.imageloader.core.assist;
...
import com.example.wallapop.utils.imageloader.utils.CheckHiddenListenter;
...
public class PauseOnScrollListener implements OnScrollListener {
	...
	private CheckHiddenListenter checkboardadperter;
	 ...
	 *            scroll events
	 */
	public PauseOnScrollListener(CheckHiddenListenter checkboardadperter,
			ImageLoader imageLoader, boolean pauseOnScroll,
			boolean pauseOnFling, OnScrollListener customListener) {
		this.imageLoader = imageLoader;
		this.pauseOnScroll = pauseOnScroll;
		this.pauseOnFling = pauseOnFling;
		this.checkboardadperter = checkboardadperter;
		externalListener = customListener;
	}
	...
	public void onScrollStateChanged(AbsListView view, int scrollState) {
		...
		case OnScrollListener.SCROLL_STATE_TOUCH_SCROLL:
			if (null != checkboardadperter) {
				checkboardadperter.SetBoard();
			}
			if (pauseOnScroll) {
				imageLoader.pause();
			}
